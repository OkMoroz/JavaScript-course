...
if (answer === 3) {
  console.log(
    `That's right. JavaScript is the best programming language in the world `
  );
} else {
  console.log(
    `That's false. This language not is the best programming language in the world `
  );
}
...
//rest1.owner = rest1.owner && '<ANONYMOYS>';
//rest2.owner = rest2.owner && '<ANONYMOYS>';
